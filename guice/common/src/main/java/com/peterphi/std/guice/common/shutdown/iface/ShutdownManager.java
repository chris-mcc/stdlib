...
public interface ShutdownManager
{
	 ...
	 */
	public void register(final StoppableService service);

	/**
	 * Request that all registered services perform an orderly shutdown. Specifically, the ShutdownManager must call the {@link
